...
def vlan_trunk_native_untag(sw1, hs1, hs2, step):
    """
    This test case will varify, port configured with vlan trunk
    ...
    # show the running conifguration to ensure that swich configured properly
    ...
    step('Ping not success !!!!negative rechability passed.')


def vlan_trunk_native_tag(sw1, hs1, hs2, step):
    """
    This test case will varify, port configured with vlan tr native will send
...
def test_ping(topology, step):
    """
    Set network addresses between nodes and ping h2 from h1.
    """
